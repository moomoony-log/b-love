...
const Dashbord = () => {
    ...
    useEffect(()=> {
        ...
        if(parent) parent.setAttribute('data-name', 'dashboard')
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <Button children={false} to={false} type="button" small="small-3" color="blue" icon="fa-regular fa-file-pen" name="Modifier"/>
