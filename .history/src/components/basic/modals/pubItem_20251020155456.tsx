        ...
        <div className="modal" data-name="pub-item" data-show>
                <div className="box">
                    ...
                    <div className="body">
                        ...
                        <Button children={false} to={false} icon="fa-regular fa-phone" type="button"name="Modifier" color="gray" />
                        <Button children={false} to={false} icon="fa-regular fa-user-minus" type="button"name="Ne plus suivre" color="red" />
                        <Button children={false} to={false} icon="fa-regular fa-siren-on" type="button"name="Signaler" color="red" />
