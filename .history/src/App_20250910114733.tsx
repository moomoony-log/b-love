...
function App() {
    ...
    <span style="font-weight: lighter;">
        ...
        En utilisant notre application [Nom de l'Application] (ci-après "l'Application"), vous acceptez les pratiques décrites dans cette politique.
        ...
        Nous utilisons des cookies et des technologies de suivi similaires pour suivre l'activité dans notre Application et conserver certaines informations. Vous pouvez refuser les cookies dans les paramètres de votre navigateur.
        ...
        Détecter et prévenir la fraude et les abus. Intérêt légitime / Obligation légale.
        ...
        Protection de nos droits : Pour protéger nos droits, notre propriété ou notre sécurité, ainsi que celle de nos utilisateurs.

        &nbsp;&nbsp;&nbsp;5. Transferts de données en dehors de l'UE
        Si nous transférons vos données vers des pays situés en dehors de l'Espace Économique Européen (EEE), nous nous assurons qu'elles bénéficient d'une protection adéquate, comme des Clauses Contractuelles Types de la Commission Européenne.

        &nbsp;&nbsp;&nbsp;6. Conservation des données
        Nous conservons vos données personnelles uniquement aussi longtemps que nécessaire pour atteindre les finalités décrites dans cette politique. Lorsque nous n'en avons plus besoin, nous les supprimons ou les anonymisons.
        ...
        Vous avez également le droit d'introduire une réclamation auprès de l'autorité de protection des données de votre pays (en France, la CNIL).

        &nbsp;&nbsp;&nbsp;8. Sécurité
        Nous mettons en œuvre des mesures de sécurité techniques et organisationnelles pour protéger vos données contre tout accès, modification, divulgation ou destruction non autorisés. Cependant, aucune méthode de transmission sur Internet ou de stockage électronique n'est sécurisée à 100%.

        &nbsp;&nbsp;&nbsp;9. Modifications de cette politique
        Nous pouvons mettre à jour cette politique de confidentialité de temps à autre. Nous vous informerons de tout changement en publiant la nouvelle politique sur cette page et en vous notifiant via l'Application ou par e-mail.
