            ...
            <div>
                <div className="head-apropos-account">
                    ...
                    <div className="content-home-btn">
                        <button type="button" className="ui-btn" name=""  data-size="small-3" color="gray"><i className="fa-regular fa-phone"></i> Contacter</button>
                ...
                <div className="remaining">
                    ...
                    <div className="section-list">
                        <div className="infos-personnels" data-name="tarif" data-active>
                        ...
                        <div className="infos-personnels" data-name="pub" data-_active>
