            ...
            <div id="app-content-left">  
                ...
                <div className="infos-account">
                 ...
                 <div className="content-home-btn" data-parent="bar-left">
                    <Button type="button" children={true} size="large" to="/home/acceuil" name="Acceuil" icon="fa-regular fa-home" border />
                    <Button type="button" children={true} size="large" to="/home/product" name="Produits" icon="fa-regular fa-home" border />
                    
                    {/* <button type="button" className="ui-btn" name=""  data-size="large"  data-border data-active> <i className=""></i> <NavLink to="/home/acceuil"> Acceuil</NavLink> </button>
