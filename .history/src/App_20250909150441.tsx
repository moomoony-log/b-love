...
const NewAccountComponent = () => {
	...
	return (
		...
		<div className="container" data-name="new-account">
			...
			<Input type="password" placeholder="Mot de passe" icon="fa-regular fa-key" validation={{minLenght:4}} />
			<Input type="password" placeholder="Confirmer le mot de passe" icon="fa-regular fa-key" validation={{minLenght:4}} />
			<div className="input-btn-container">
				<Button size="large" type="button" outline="true" onclick={change}/>
			</div>
			<div className="regist">
				<Button size="large" type="button" outline="true" onclick={change} name="Continuer avec Google"/>
			</div>
		</div>
		</>
	)
