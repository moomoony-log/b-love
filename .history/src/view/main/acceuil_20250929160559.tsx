            ...
            <div className="pub-item" data-type="COMPTE SIGNALÉ" data-exit>
                <div className="heads">
                    ...
                    <div className="about-pub-item-btn">
                        <Button children={false} type="button" to={false} size="true" small="small-2" name="Suivre"/> 
                        <Button children={false} type="button" to={false} size="true" icon="fa-duotone fa-solid fa-siren-on" color="red"/> 
                    </div>
                </div>
