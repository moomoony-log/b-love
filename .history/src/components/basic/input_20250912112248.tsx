...
const Input = forwardRef<InputRef,InputProps>(({type, name, placeholder, icon,onChangeCheckBox, validation}, ref) =>{
    ...
    return (
        ...
        type === "text"  || type === "password" || type === "email"  ? 
            ...
            <div className="chekbox">
                <input type={type} id={userId} autoComplete="off"  onChange={onChangeCheckBox} checked/> 
