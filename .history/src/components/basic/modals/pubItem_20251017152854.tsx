    ...
    return(
        ...
        <div className="modal" data-name="pub-item" data-show>
                <div className="box">
                    ...
                    <div className="body">
                        <Button children={false} to={false} icon="fa-regular fa-phone" type="button"name="Acceder au compte" color="gray" />
                        <Button children={false} to={false} icon="fa-regular fa-phone" type="button"name="Ajouter aux favaories" color="gray" />
