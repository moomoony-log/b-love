...
const Input = forwardRef<InputRef,InputProps>(({type, name, placeholder, icon,onChangeCheckBox, check, validation}, ref) =>{
    ...
    return (
        ...
        type === "text"  || type === "password" || type === "email" || type === "date"  ? 
            ...
            <div className="otp-input"><input type="text" disabled maxLength={1} placeholder=""  autoComplete="off"/> </div> : ""
        }
        </>
    )
