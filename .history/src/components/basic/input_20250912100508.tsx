...
const Input = forwardRef<InputRef,InputProps>(({type, name, placeholder, icon, validation}, ref) =>{
    ...
    const onChangeCheckBox = (e:React.ChangeEvent<HTMLInputElement>): boolean =>{
        if(e.target.checked) setIsValid(e.target.checked) 
    ...
    useImperativeHandle(ref, () => ({
        isValid,
        validate: type !== "checkBox" ?  validateCurrentValue : ()=> isValid
    }),[isValid, value])
    ...
    return (
        ...
        type === "text"  || type === "password" || type === "email"  ? 
            ...
            <div className="chekbox">
                <input type={type} id={userId} autoComplete="off"onChange={onChangeCheckBox}/> 
