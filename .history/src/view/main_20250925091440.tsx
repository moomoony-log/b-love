            ...
            <div id="app-content-left">  
                ...
                <div className="infos-account">
                 ...
                 <div className="content-home-btn" data-parent="bar-left">
                    <Button type="button" size="large" ><NavLink to="/home/acceuil"> Acceuil</NavLink></Button>
                    <Button type="button" size="large" ><NavLink to="/home/product">Produits</NavLink></Button>
            ...
            <div id="app-content-right">
                <div className="head">
                    ...
                    <div className="navigation-btn dos">
                        ...
                        <button type="button" className="ui-btn" name=""  data-size="large"  data-navigate ><i className="fa-solid fa-bell" title="Notifications" count="+25"></i> </button>                                                                                     
                    </div>
                </div>
