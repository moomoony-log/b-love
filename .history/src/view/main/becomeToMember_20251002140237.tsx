            ...
            <div className="informations">
                <div className="info-identity">
                    ...
                    <div className="form-group">
                        ...
                        <Input icon="fa-regular fa-user" type="date" placeholder="Date de naissance"  />
                        <div className="ui-input" theme="alpha" name="birthday" _error="" _state="bad">
                            <label htmlFor="look"><i className="fa-regular fa-cake-candles"></i></label>
                            <input type="date" placeholder="Date de naissance" id="look" autocomplete="off"> 
                        </div>
                    </div>
                </div>
                <div className="info-identity">
                    ...
                    <div className="form-group">
                        <div className="ui-input" theme="alpha" name="residence" _error="" _state="bad">
                            <label for="mpo"><i className="fa-regular fa-house"></i></label>
                            <input type="text" placeholder="Lieu de residence" id="mpo" autocomplete="off"> 
                        </div>
                    </div>
                </div>
                <div className="info-identity">
