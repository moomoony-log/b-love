...
const NewAccountComponent = () => {
	...
	const a = (e:React.ChangeEvent<HTMLInputElement>):boolean => {
		let valid = true
		if (e.target.checked) {
			valid = true
	...
	return (
		<>
			<div className="container" data-name="new-account">
				...
				<Input type="checkBox" onChangeCheckBox={a} {...(activeAuthBtn && {check: true})} />

				<div className="input-btn-container">
					<Button size="large" type="button" outline="true" onclick={change} icon="fa-regular fa-right-to-bracket"{...(!activeAuthBtn && {disable: true})} />
				</div>
