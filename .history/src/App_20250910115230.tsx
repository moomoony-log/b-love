				...
				<div className="auth-container">
					...
					<div className="rule-present cool-scroll-bar" style={{ display: "one" }} ref={conditionOfUseCont}>
						...
						<span style={{fontWeight: "lighter"}}>
							...
							En utilisant notre application [Nom de l'Application] (ci-après "l'Application"), vous acceptez les pratiques décrites dans cette politique. <br />
							...
							Nous utilisons des cookies et des technologies de suivi similaires pour suivre l'activité dans notre Application et conserver certaines informations. Vous pouvez refuser les cookies dans les paramètres de votre navigateur. <br />
							...
							Détecter et prévenir la fraude et les abus. Intérêt légitime / Obligation légale. <br />
							...
							Protection de nos droits : Pour protéger nos droits, notre propriété ou notre sécurité, ainsi que celle de nos utilisateurs. <br />

							&nbsp;&nbsp;&nbsp;5. Transferts de données en dehors de l'UE
							Si nous transférons vos données vers des pays situés en dehors de l'Espace Économique Européen (EEE), nous nous assurons qu'elles bénéficient d'une protection adéquate, comme des Clauses Contractuelles Types de la Commission Européenne. <br />

							&nbsp;&nbsp;&nbsp;6. Conservation des données
							Nous conservons vos données personnelles uniquement aussi longtemps que nécessaire pour atteindre les finalités décrites dans cette politique. Lorsque nous n'en avons plus besoin, nous les supprimons ou les anonymisons. <br />
							...
							Pour exercer ces droits ou pour toute question sur cette politique, contactez-nous à : [Votre adresse e-mail dédiée à la protection des données/privacy@votresite.com].

							Vous avez également le droit d'introduire une réclamation auprès de l'autorité de protection des données de votre pays (en France, la CNIL). <br />

							&nbsp;&nbsp;&nbsp;8. Sécurité
							Nous mettons en œuvre des mesures de sécurité techniques et organisationnelles pour protéger vos données contre tout accès, modification, divulgation ou destruction non autorisés. Cependant, aucune méthode de transmission sur Internet ou de stockage électronique n'est sécurisée à 100%. <br />

							&nbsp;&nbsp;&nbsp;9. Modifications de cette politique
							Nous pouvons mettre à jour cette politique de confidentialité de temps à autre. Nous vous informerons de tout changement en publiant la nouvelle politique sur cette page et en vous notifiant via l'Application ou par e-mail. <br />

							Pour nous contacter :
							Pour toute question relative à cette politique de confidentialité ou à vos données, veuillez nous contacter à l'adresse suivante : [Adresse e-mail de contact].
						</span>
						</span>
					</div>
