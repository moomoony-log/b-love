...
function App() {
	...
	const [activeAccountBtn, setActiveAccountBtn] = useState(true)
		...
		<>
			<div id="auth">
				...
				<div className="head" >
					...
					{activeAccountBtn && (<Button type="button" name="Vous n'avez pas de compte" color="" size="small" icon="fa-solid fa-circle-question" onclick={newAccountAction} ref={newAccountBtn}/>)}
					<Button type="button" name="Vous avez dèjà un compte " color="" size="small" icon="fa-solid fa-circle-question" onclick={newAccountAction} />
