...
const EmailRecoveryComponent = () => {
    ...
    return (
        ...
        <div className="container" data-name="forget-password">
            ...
            <div className="input-btn-container">
                <Button onclick={chekValidEmail} size="large" type="button" outline="" icon="fa-regular fa-right-to-bracket"/>
            </div>
        </div>
        </>
    )
        ...
        <>
            <div id="auth">
                <div className="head" >
                    ...
                    {emailRecoveryCont && (<Button type="button" name="Retour" color="" size="small" icon="fa-solid fa-circle-question" onclick={showEmailRecovery} />)}
                </div>
