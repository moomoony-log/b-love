    ...
    return (
        ...
        <div className="cont-apropos-account cool-scroll-bar" date-member="Membre depuis 2025">
            <div>
                ...
                <div className="infos-personnels" name="bio">
                    <span>Convictieux et jeune, belle venduese de mouvement</span>
                </div>
                <div className="remaining">
                    <div className="section-controls">
                        <span className="info-title" active><i className="fa-duotone fa-money-bill-1-wave"></i> Tarifs</span>
                    ...
                    <div className="section-list">
                        <div className="infos-personnels" name="tarif" _active>
                        ...
                        <div className="infos-personnels" name="statut" _active>
                            <div className="availability">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>00H - 01H</td>
                                            <td><span className="state" state="liberty">LIBRE</span></td>
                                            <td>
                                                <button type="button" className="ui-btn" name="" size="small-3" color=""><i className="fa-solid fa-calendar-days"></i> RESERVER</button>
                                                <button type="button" className="ui-btn" name="" size="small-3" color=""><i className="fa-regular fa-phone"></i> CONTACTER</button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>01H - 02H</td>
                                            <td><span className="state" state="oqp">OCCUPEE</span></td>
                                            <td>
                                                <button type="button" className="ui-btn" name="" size="small-3" color=""><i className="fa-regular fa-phone"></i> CONTACTER</button>
                                            </td>
                                        </tr>
                        ...
                        <div className="infos-personnels" name="pub" active>
                            <div className="container-my-pub">
                                <div className="item-pub" vue="10M">
                                    <img src="../img/cardi_b.webp" alt="account-image">
                                </div>
                                <div className="item-pub" vue="1.2M">
                                    <img src="../img/cardi_b.webp" alt="account-image">
                                </div>
                                <div className="item-pub" vue="18k">
                                    <img src="../img/cardi_b.webp" alt="account-image">
                                </div>
                                <div className="item-pub" vue="6.5K">
                                    <img src="../img/cardi_b.webp" alt="account-image">
                                </div>
                                <div className="item-pub" vue="655">
                                    <img src="../img/cardi_b.webp" alt="account-image">
                                </div>
                                <div className="item-pub" vue="352">
                                    <img src="../img/cardi_b.webp" alt="account-image">
                                </div>
                                <div className="item-pub" vue="145">
                                    <img src="../img/cardi_b.webp" alt="account-image">
                                </div>
                                <div className="item-pub" vue="1k">
                                    <img src="../img/cardi_b.webp" alt="account-image">
                                </div>
                                <div className="item-pub"vue="650k" >
                                    <img src="../img/cardi_b.webp" alt="account-image">
                                </div>
                                <div className="item-pub" vue="250k">
                                    <img src="../img/cardi_b.webp" alt="account-image">
                                </div>
                                <div className="item-pub" vue="65">
