    ...
    return(
        ...
        <div className="modal" data-name="pub-item" data-show>
                <div className="box">
                    ...
                    <div className="body">
                        <div className="about-pub" data-dat>
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo soluta in necessitatibus, ad eligendi aperiam fugit, nesciunt eos, quis pariatur veritatis? Nostrum enim illo voluptas dolore alias ullam minus amet quaerat neque, saepe ipsum, modi sit suscipit repudiandae? Eum natus porro neque quos consequuntur voluptatem, necessitatibus recusandae nesciunt. Quisquam repellendus dicta cupiditate dignissimos ex quasi exercitationem molestias a libero architecto iure quos modi, eum minus excepturi error! Iure consequuntur dolorem neque minima cumque distinctio possimus quo quidem hic, harum amet molestiae, sapiente atque vero, in quam aspernatur! Quidem praesentium veniam quibusdam magnam, neque adipisci aut! Magnam sapiente dolore dolores mollitia.
                        </div>
