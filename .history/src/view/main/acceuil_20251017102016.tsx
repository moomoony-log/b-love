         ...
         <div className="cont-body cool-scroll-bar"> 
            ...
            <div className="pub-item" data-type="COMPTE VERIFIÉ" data-good>
                <div className="heads">
                    ...
                    <div className="about-pub-item-btn">
                        <Button children={false} type="button" to={false} icon="fa-regular fa-plus-large" name="Suivre"/> 
                        <Button children={false} type="button" to={false} icon="fa-duotone fa-solid fa-siren-on"/>
                    </div>
                </div>
                <div className="pub-content">
                    <div className="more-info">
                ...
                <div className="pub-content">
                    ...
                    <div className="medias-body">
                        <div className="cont-account-img" data-img><img src="../img/cardi_b.webp" alt="account-image"/></div>
                    </div>
                </div> 
                <div className="pub-controller">
                    <div className="resum-controller">
