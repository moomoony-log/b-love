...
const OptContComponent = () => {
    ...
    const validOtp = ()=> {
        console.log("1: ->", otpInputState.current?.validate);
        console.log("2: ->", otpInputState1.current?.validate);
        console.log("3: ->", otpInputState2.current?.validate);
        console.log("4: ->", otpInputState3.current?.validate);
        console.log("5: ->", otpInputState4.current?.validate);
    }
