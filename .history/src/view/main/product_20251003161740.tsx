...
const Product = () => {
    ...
    return (
        ...
        <div className="product-category cool-scroll-bar">
            <div className="category-item" data-active>
            ...
            <div className="category-item">
             ...
             <div className="category-item">
                ...
                <div>
                    <span>Produits sexe</span>
                    <span>255 articles</span>
                </div>
            </div>
             <div className="category-item">
                <img src="../img/bikini.jpg" alt="account"/>
                <div>
             ...
             <div className="category-item">
                <img src="../img/capote.png" alt="account"/>
                <div>
        ...
        <div className="products-container cool-scroll-bar" >
            ...
            <div className="product-item">
                ...
                <span className="descrip">Produit pour adulte en bonne santé donc rests au clalaùee</span>
                <div className="detail">
                    <span><i className="fa-duotone fa-solid fa-money-bill-wave"></i> 1 250  F</span>
                    <span>Yopougon</span>
                </div>
            </div>
            <div className="product-item">
