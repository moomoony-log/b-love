...
const Main = () => {
    ...
    console.log(appContent.current?.parentElement);
            ...
            <div id="app-content-left">  
                ...
                <div className="infos-account">
                 ...
                 <div className="content-home-btn" data-parent="bar-left">
                    <button type="button" className="ui-btn" name=""  data-size="large"  data-border data-active> <i className="fa-regular fa-home"></i> Acceuil</button>
