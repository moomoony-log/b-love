...
import NotificationItem from "../components/basic/notification";
		...
		<>
			<div className="container" data-name="new-account">
				...
				<div className="input-btn-container">
					<Button type="button" outline="true" onclick={change} icon="fa-regular fa-right-to-bracket" children={false} to={false} color="gray" {...(!activeAuthBtn && {disable: true})} />
				</div>
				<div className="regist">
					<Button type="button" outline="true" onclick={change}children={false} to={false} name="Continuer avec Google" icon="fa-brands fa-google"/>
				</div>
			</div>
		</>
	)
...
const EmailRecoveryComponent = () => {
    ...
    return (
        ...
        {active ? 
            ...
            <div className="input-btn-container">
                <Button onclick={chekValidEmail} type="button" outline="true" icon="fa-regular fa-right-to-bracket" children={false} to={false}/>
            </div>
...
const Auth = () => {
    ...
    return (
        <>
           <div id="notification">
                <NotificationItem text="Opps! Mot de passe incorrect" title="ATTENTION" type="exit" />
                <NotificationItem text="Opps! Mot de passe incorrect" title="ATTENTION" type="exit" />
                <NotificationItem text="Opps! Mot de passe incorrect" title="ATTENTION" type="exit" />
                <NotificationItem text="Opps! Mot de passe incorrect" title="ATTENTION" type="exit" />
           </div>
