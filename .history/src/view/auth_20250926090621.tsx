...
const OptContComponent = () => {
    ...
    return (
        ...
        <div className="container" data-name="otp" >
            ...
            <div className="input-btn-container">
                <Button type="button" onclick={validOtp} size="large" outline="true" icon="fa-regular fa-right" disable children={false}  to={false} />
            </div>
        </div>
        </>
    )
        ...
        <>
            <div id="auth">
                <div className="head" >
                    ...
                    {activeNewAccountBtn && (<Button type="button" children={false} to={false} name="Vous n'avez pas de compte" color="" size="small" icon="fa-solid fa-circle-question" onclick={newAccountAction} />)}
                    {activeAccountBtn && (<Button type="button" children={false} to={false} name="Vous avez dèjà un compte " color="" size="small" icon="fa-solid fa-circle-question" onclick={accountAction} />)}
                    {emailRecoveryCont && (<Button children={false} to={false} type="button" name="Retour" color="" size="small" icon="fa-solid fa-rotate-left" onclick={accountAction} />)}
                </div>
