    ...
    return (
        ...
        <div id="app" ref={mainRef}>
            ...
            <div id="app-content-right">
                <div className="head">
                    <div className="cont-head">
                        ...
                        <div className="navigation-btn">
                            <Button type="button" navigate="true" children={true} size="large" small="small-3" to="/home/acceuil" name="Acceuil" icon="fa-regular fa-home" border={true} />
                ...
                <div className="body">
                    <div className="body-2" data-name="dashboard__">
                        <Outlet/>
                    </div>
                </div>
            </div>
