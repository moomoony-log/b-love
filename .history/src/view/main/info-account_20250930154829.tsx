    ...
    return (
        ...
        <div className="cont-account-controler">  
            <div className="content-home-btn" data-parent="bar-right">
                <button type="button" className="ui-btn" name=""   data-border data-active onClick={()=> navigate("/home/client/compte")}><i className="fa-duotone fa-solid fa-receipt"></i> <span>Mon compte</span></button>
