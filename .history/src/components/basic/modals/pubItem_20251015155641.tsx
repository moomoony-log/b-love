                ...
                <div className="box">
                    ...
                    <div className="body">
                        ...
                        <div className="pub-info">
                            ...
                            <div className="two">
                                <span className="phone" ><i className="fa-regular fa-phone"></i> +225 07 79 29 8268</span>
                                <Button children={false} to={false} icon="fa-regular fa-phone" type="button"name="WhatsApp" />
                            </div>
