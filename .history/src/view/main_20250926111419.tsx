                ...
                <div className="head">
                    <div className="cont-head">
                        ...
                        <div className="navigation-btn">
                             <Button type="button" children={true} size="large" to="/home/acceuil" name="Acceuil" icon="fa-regular fa-home" border={true} />
                            <Button type="button" children={true} size="large" to="/home/product" name="Produits" icon="fa-regular fa-cart-shopping" border={true} />
                            <Button type="button" children={true} size="large" to="/home/favories" name="Favories" icon="fa-regular fa-star" border={true} />
                            <Button type="button" children={true} size="large" to="/home/check" name="Localiser" icon="fa-regular fa-map-location-dot" border={true}/>                                                                                   
                        </div>
