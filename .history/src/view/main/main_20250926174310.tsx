...
const Acceuil = () => {
    ...
    return (
            ...
            <div className="pub-item" data-type="COMPTE SIGNALÉ" data-exit>
                ...
                <div className="pub-content">
                    ...
                    <div className="medias-body">
                        <div className="cont-account-img" img="+ 22 photos"><img src="../img/amber-rose-21-savage.jpg" alt="account-image"></div>
                    </div>
                </div>
                <div className="pub-controller">
                    <div className="resum-controller">
                        <div className="cont-account-img" name="like"><img src="../img/cardi_b.webp" alt="account-image"></div>
                        <div className="cont-account-img" name="like"><img src="../img/cardi_b.webp" alt="account-image"></div>
                        <div className="cont-account-img" name="like"><img src="../img/cardi_b.webp" alt="account-image"></div>
                        <div className="cont-account-img" name="like"><img src="../img/cardi_b.webp" alt="account-image"></div>
                        <span> 3,6k <i className="fa-solid fa-thumbs-up"></i></span>
                    </div>
                    <div className="content-home-btn" parent="pub-item">
                        <button type="button" className="ui-btn" name="password-forget"  size="large"  border ><i className="fa-regular fa-phone"></i></button>
                        <button type="button" className="ui-btn" name="password-forget"  size="large"  border ><i className="fa-regular fa-heart"></i></button>
                    </div>
                </div>
            </div>
            <div className="pub-item" type="COMPTE VERIFIÉ" good>
                <div className="heads">
                    <div className="info-account-about">
                        <div className="cont-account-img" name="pub-2"><img src="../img/cardi_b.webp" alt="account-image"></div>
                        <div className="identity">
                            <span className="name">Cristiano Ronaldo</span>
                    ...
                    <div className="about-pub-item-btn">
                        <button type="button" className="ui-btn" name="password-forget"  size="small"  ><i className="fa-regular fa-plus-large"></i> Suivre</button>
                        <button type="button" className="ui-btn" name="password-forget"  size="small-4"  border color="red" title="Signaler"><i className="fa-duotone fa-solid fa-siren-on"></i> </button>
                    </div>
                </div>
                <div className="pub-content">
                    <div className="more-info">
                    ...
                    <div className="medias-body">
                        <div className="cont-account-img" img><img src="../img/amber-rose-21-savage.jpg" alt="account-image"></div>
                    </div>
                </div> 
                <div className="pub-controller">
                    <div className="resum-controller">
        ...
        <div className="account-discussion">
            <div class="tandance">
                <span class="title"><i class="fa-duotone fa-earth-americas"></i> En ligne</span>
                <div class="info-account-about" online>
                    <div class="cont-account-img" name="pub-2"><img src="../img/cardi_b.webp" alt="account-image"></div>
                    <div class="identity">
                        <span class="name">Cristiano Ronaldo</span>
                        <span class="date">Sam, 17 Juil 15:59</span>
                    </div>
                </div>
                <div class="info-account-about" online>
                    <div class="cont-account-img" name="pub-2"><img src="../img/cardi_b.webp" alt="account-image"></div>
                    <div class="identity">
                        <span class="name">Cristiano Ronaldo Agent Delafosse</span>
                        <span class="date">Sam, 17 Juil 15:59</span>
                    </div>
                </div>
                <div class="info-account-about">
                    <div class="cont-account-img" name="pub-2"><img src="../img/cardi_b.webp" alt="account-image"></div>
                    <div class="identity">
                        <span class="name">Cristiano Ronaldo</span>
                        <span class="date">Sam, 17 Juil 15:59</span>
            ...
            <div class="marketing">
                <div class="marketing-head">
                    <span><i class="fa-duotone fa-megaphone"> </i> Publicité</span>
                ...
                <div class="marketing-content">
                    <div class="item">
                        <div class="pb">
                            <span></span>
                            <div class="marketing-img"><img src="../img/air-force.avif" alt="pub-img"></div>
                            <span></span>
                        </div>
                        <span class="text-marketing">
                            <p>Special Sneaker</p>
